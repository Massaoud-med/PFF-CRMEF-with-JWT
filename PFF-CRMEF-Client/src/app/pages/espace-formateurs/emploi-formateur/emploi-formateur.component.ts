...
@Component({
  selector: 'app-emploi-formateur',
  templateUrl: './emploi-formateur.component.html',
  styleUrls: ['./emploi-formateur.component.scss']
})
export class EmploiFormateurComponent implements AfterViewInit {
